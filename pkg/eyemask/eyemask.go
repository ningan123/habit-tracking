...
var (
	EyeMaskTargetWeekFinishDays int = 3
	EyeMaskTargetMonthFinishDays int = 12
	EyeMaskTargetYearFinishDays int = EyeMaskTargetMonthFinishDays*12
)
...
func NewEyeMask(rawInfo map[string]string) *EyeMask {
	return &EyeMask{
		RawInfo: rawInfo,
...
func(g *EyeMask) GenDayInfo() error {
...
func(r *EyeMask) GenWeekInfo() error {
  ...
  for date, rawInfo := range r.RawInfo {
		...
		if r.WeekInfo[weekNum] == nil {
			...
			r.WeekInfo[weekNum], err = hTickType.NewWeekTickType(weekNum, weekRawInfo, EyeMaskTargetWeekFinishDays)
			if err != nil {
			  return err
			}
		}
...
func(g *EyeMask) GenMonthInfo() error {
  ...
  for date, rawInfo := range g.RawInfo {
		...
		if g.MonthInfo[monthNum] == nil {
		  monthRawInfo := make(map[int]*hTickType.DayTickType)
			g.MonthInfo[monthNum], err = hTickType.NewMonthTickType(monthNum,daysInMonth, monthRawInfo, EyeMaskTargetMonthFinishDays)
			if err != nil {
			  return err
			}
		}
...
func(r *EyeMask) GenYearInfo() error {
  ...
  for date, rawInfo := range r.RawInfo {
		...
		if r.YearInfo[yearNum] == nil {
			...
			r.YearInfo[yearNum], err = hTickType.NewYearTickType(yearNum, daysInYear, yearRawInfo, EyeMaskTargetYearFinishDays)
			if err != nil {
			  return err
			}
		}
...
func (g *EyeMask) CheckFinish() error {
...
func (g *EyeMask) CheckDayFinish() error {
...
func (g *EyeMask) CheckWeekFinish() error {
...
func (g *EyeMask) CheckMonthFinish() error {
...
func (g *EyeMask) CheckYearFinish() error {
...
func (g *EyeMask) ConvertInfoToOrderInfo() error {
...
func (g *EyeMask) ConvertDayInfoToDayOrderInfo() error {
...
func (r *EyeMask) ConvertWeekInfoToWeekOrderInfo() error {
...
func (r *EyeMask) ConvertMonthInfoToMonthOrderInfo() error {
...
func (r *EyeMask) ConvertYearInfoToYearOrderInfo() error {
