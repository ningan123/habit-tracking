...
func MonthReadingHtmlTable(w http.ResponseWriter) {
	...
	fmt.Fprintf(w, "<body>\n")
	fmt.Fprintf(w, "<table border='1'>\n")
	fmt.Fprintf(w, "<tr><th>monthNum</th><th>monthReadingTime</th><th>targetReadingTime</th><th>extraReadingTime</th><th>content</th><th>finish</th></tr>\n")
...
func YearReadingHtmlTable(w http.ResponseWriter) {
	...
	fmt.Fprintf(w, "<body>\n")
	fmt.Fprintf(w, "<table border='1'>\n")
	fmt.Fprintf(w, "<tr><th>yearNum</th><th>yearReadingTime</th><th>targetReadingTime</th><th>extraReadingTime</th><th>content</th><th>finish</th></tr>\n")
